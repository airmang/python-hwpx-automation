...
>
> 릴리스 상태: `released` — 7.2.0 공개 발행과 실제 marketplace 설치를 관찰했습니다.
...
현재 공개 트레인의 계약은 `5e5c23651f92785a`입니다(이전 공개 계약 `ba0211fc854a0a97`).
...
기준 upstream 버전 바닥은 `python-hwpx >= 6.4.0`입니다. 설치 계약은 기본
128개/고급 136개/스킬 필수 29개이며, automation 바닥은 `7.1.0`, skill
바닥은 `2.0.0`입니다.
호환·deprecated 도구는
